/* PEAK_SETUP — make the OS adapt: primary vs secondary, classes, subjects, A-level combinations */
window.PEAK_SETUP = (function () {
  ...
  return { Setup, detectLevel: detectLevel, vocabFor: vocabFor, PRESETS: PRESETS };
})();
