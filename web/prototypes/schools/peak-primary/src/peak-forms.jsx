...
// Peak Primary · Forms (modals)
// Add Student · Add Teacher · Record Payment

window.PEAK_FORMS = (function () {
  ...
  return { AddStudent, AddTeacher, RecordPayment, Confirm, ReceiptResult, Receipts, ImportStudents, FeesImport, NewAssignment };
})();
