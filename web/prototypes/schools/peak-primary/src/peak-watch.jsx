/* PEAK_WATCH — Nia on guard: scans the live OS for gaps, anomalies, overload, things that don't fit, and what changed. Rule-based, always-on, free. */
window.PEAK_WATCH = (function () {
