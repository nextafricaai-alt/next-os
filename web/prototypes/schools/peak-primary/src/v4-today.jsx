      ...
      <div style={{ background: T.surface, border: '1px solid ' + T.border, borderRadius: 14, padding: 18 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 4 }}>
            <button onClick={function () { setCur(new Date(y, m - 1, 1)); }} style={{ background: 'transparent', border: '1px solid ' + T.border, color: T.ink2, borderRadius: 7, width: 26, height: 26, cursor: 'pointer' }}>{'‹'}</button>
            <button onClick={function () { setCur(new Date(y, m + 1, 1)); }} style={{ background: 'transparent', border: '1px solid ' + T.border, color: T.ink2, borderRadius: 7, width: 26, height: 26, cursor: 'pointer' }}>{'›'}</button>
          </div>
        </div>
