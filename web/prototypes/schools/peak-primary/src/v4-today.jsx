          ...
          <aside className="today-aside" style={{
            ...
            <div style={{ padding: '22px 22px 18px', borderBottom: '1px solid ' + T.border }}>
              ...
              <div style={{
                ...
                {(function(){var h=new Date().getHours();return h<12?'Good morning':h<17?'Good afternoon':'Good evening';})() + ' ' + (function(){var p=(window.PEAK_ROLE&&window.PEAK_ROLE.getProfile&&window.PEAK_ROLE.getProfile())||{};return ((p.fullName||'').trim().split(' ')[0])||'there';})() + '. The school is calm. Three things worth knowing before you start:'}
              </div>
            </div>
