-- ====================================================================
-- SUPABASE CLEANUP & DEDUPLICATION SCRIPT FOR KABS LILY JUNIOR SCHOOL
-- Run this in the Supabase SQL Editor to wipe duplicate demo data
...
BEGIN
  ...
  -- 3. Populate school_income with exact matching fees ledger
