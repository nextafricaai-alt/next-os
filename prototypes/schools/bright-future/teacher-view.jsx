...
(function () {
  ...
  function NiaCoachCard({ data, onTakeRollCall, onLogHealth, onScrollToCheckin }) {
    ...
    const toneBg    = (t) => t === 'warn' ? 'rgba(255,180,0,0.06)'
                          : t === 'positive' ? 'rgba(59,130,246,0.06)'
                          : 'rgba(59,130,246,0.06)';
    const toneBorder = (t) => t === 'warn' ? 'rgba(255,180,0,0.18)'
                            : t === 'positive' ? 'rgba(59,130,246,0.18)'
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 18 }}>
          <div style={{
            ...
            background: 'rgba(59,130,246,0.15)', color: T.green,
  ...
  function NiaCheckinPopup({ teacher, profile, onCheckedIn }) {
    ...
    return (
      <div style={{
        ...
        borderRadius: 14,
        padding: 18,
        boxShadow: '0 24px 60px rgba(0,0,0,0.45), 0 0 0 1px rgba(59,130,246,0.10)',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
          <div style={{
            ...
            background: 'rgba(59,130,246,0.18)', color: T.green,
  ...
  function CheckInCard({ teacher, checkin, onCheckedIn, onCheckedOut, profile }) {
    ...
    const tokens = {
      ...
      in:   { bg: 'rgba(59,130,246,0.10)', border: 'rgba(59,130,246,0.25)', icon: '✓', iconBg: 'rgba(59,130,246,0.18)', iconColor: T.green },
  ...
  function LessonsCard({ lessons }) {
    const statusStyle = (s) => ({
      delivered: { bg: 'rgba(59,130,246,0.12)', fg: T.green, label: 'DELIVERED' },
  ...
  function PayslipCard({ payroll }) {
    ...
    const statusStyle = (s) => ({
      paid:    { bg: 'rgba(59,130,246,0.12)',  fg: T.green, label: 'PAID' },
      ...
      <div style={{ minHeight: '100vh', background: T.bg, color: T.ink, fontFamily: T.font }}>
        <header style={{
          ...
          <div style={{
            ...
            background: 'linear-gradient(135deg, #3B82F6, #204887)',
            display: 'grid', placeItems: 'center', flexShrink: 0,
            fontFamily: T.serif, fontSize: 20, fontWeight: 700, color: T.bg,
          }}>P</div>
          <div style={{ flex: 1, lineHeight: 1.15, minWidth: 140 }}>
            <div style={{ fontSize: 14, fontWeight: 600, color: T.ink }}>Bright Future Academy</div>
        ...
        <main style={{ padding: '32px 32px 60px', maxWidth: 1400, margin: '0 auto' }}>
          <div style={{ marginBottom: 24 }}>
            ...
            <p style={{ margin: '8px 0 0', color: T.ink3, fontSize: 14 }}>Here's your day at Bright Future Academy.</p>
          </div>
