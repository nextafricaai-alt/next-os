...
(function () {
  ...
  const STATUS_TOKENS = {
    green:  { bg: 'rgba(59,130,246,0.16)',  border: 'rgba(59,130,246,0.4)',  fg: '#3B82F6', glow: '0 0 12px rgba(59,130,246,0.25)' },
                  ...
                  return (
                    <tr key={row.period}>
                      <td style={{
                        ...
                        padding: '10px 12px', background: isCurrent ? 'rgba(59,130,246,0.06)' : T.surface,
                        borderBottom: '1px solid ' + T.border,
                        fontSize: 12,
                      }}>
