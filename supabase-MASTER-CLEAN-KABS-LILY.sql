...
-- This wipes all old demo data (Brian Mukasa, Shuttle Fuel, etc.) and populates
-- 100% real Kabs Lily data across all tables (Students, Teachers, Income, Fees).
-- ==========================================================================================
...
BEGIN
  ...
  -- 2. INSERT REAL KABS LILY TEACHERS (15 Staff Members)
  ...
  -- 3. INSERT EXACTLY 131 REAL KABS LILY STUDENTS (22 Boarding + 109 Day Scholars)
